=== Nested Pages (Vertical & Horizontal Tree View) ===
Contributors: wp-buy
Tags: Nested Pages, page, pages, posts, structure, Hierarchy, custom posts, tree, cms, dashboard, overview, drag-and-drop, rearrange, management, manage, admin, Product Category Tree, subpages, Horizontal Tree, vertical tree
Requires at least: 3.9
Tested up to: 5.3.2
Stable tag: Version: 1.6
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html

Dynamically adds an editable tree view of your site’s page structure
