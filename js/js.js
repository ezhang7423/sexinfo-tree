...
jQuery(document).on(
  "click",
  ".wm-tree-container:first div ul li i:first",
  function(e) {
    console.log(1111);
    var data_height = jQuery(this)
      .parents(".wm-tree-container")
      .attr("data-height");
...
jQuery(document).on(
  "click",
  ".wm-tree-container div ul li.jstree-closed i:first",
  function(e) {
    console.log(2222);
    jQuery(".jstree-open .jstree-icon.jstree-ocl")
      .parent("li")
      .parent("ul")
      .parent("div")
      .parent(".wm-tree-container")
      .height("auto");
    jQuery(this)
      .parent("ul")
      .parent("div")
